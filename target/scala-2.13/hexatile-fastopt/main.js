...
function $s_LHexatileApp__main__AT__V(args) {
  $m_LHexatileApp$().main__AT__V(args);
}
/** @constructor */
function $c_LHexatileApp$() {
}
$c_LHexatileApp$.prototype = new $h_O();
$c_LHexatileApp$.prototype.constructor = $c_LHexatileApp$;
/** @constructor */
function $h_LHexatileApp$() {
}
$h_LHexatileApp$.prototype = $c_LHexatileApp$.prototype;
$c_LHexatileApp$.prototype.main__AT__V = (function(args) {
  document.addEventListener("DOMContentLoaded", ((arg1$2) => {
    $m_LHexatileApp$().setupUI__V();
  }));
});
$c_LHexatileApp$.prototype.setupUI__V = (function() {
  var button = document.createElement("button");
  button.textContent = "Click me!";
  button.addEventListener("click", ((arg1$2) => {
    $m_LHexatileApp$().addClickedMessage__V();
  }));
  document.body.appendChild(button);
  this.appendPar__Lorg_scalajs_dom_Node__T__V(document.body, "Hello World");
});
$c_LHexatileApp$.prototype.appendPar__Lorg_scalajs_dom_Node__T__V = (function(targetNode, text) {
  var parNode = document.createElement("p");
  parNode.textContent = text;
  targetNode.appendChild(parNode);
});
$c_LHexatileApp$.prototype.addClickedMessage__V = (function() {
  this.appendPar__Lorg_scalajs_dom_Node__T__V(document.body, "You clicked the button!");
});
var $d_LHexatileApp$ = new $TypeData().initClass($c_LHexatileApp$, "HexatileApp$", ({
  LHexatileApp$: 1
}));
var $n_LHexatileApp$;
function $m_LHexatileApp$() {
  if ((!$n_LHexatileApp$)) {
    $n_LHexatileApp$ = new $c_LHexatileApp$();
  }
  return $n_LHexatileApp$;
}
...
$s_LHexatileApp__main__AT__V(new ($d_T.getArrayOf().constr)([]));
}).call(this);
